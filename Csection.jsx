...
const Csection = () => {
  ...
  const [uploads, setUploads] = useState({
    deathCertificate: { status: "pending", file: null },
    relativeReport: { status: "pending", file: null },
    pradhanReport: { status: "pending", file: null },
  });

  const [verificationProgress, setVerificationProgress] = useState(0);

  useEffect(() => {
    // Check if all required uploads have a file
  ...
  const uploadSections = [
    {
      ...
      title: "Submit Death Certificate",
      icon: <FaUpload />,
    },
    {
      key: "relativeReport",
      title: "Submit Relative Section Report",
      icon: <FaUpload />,
    },
    {
      key: "pradhanReport",
      title: "Submit Prasad/Pradhan Section Report",
      icon: <FaUpload />,
    },
  ];

  return (
    <div className={styles.csectionWrapper}>
      {/* Header */}
